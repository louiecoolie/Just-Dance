...
-- UI component responsible for showing a section that is defined somewhere in the vehicle's loadout tree, along with its stats, such as Health and Armor, as well
-- as components associated with it (like turrets and the weapons equipped to it)
